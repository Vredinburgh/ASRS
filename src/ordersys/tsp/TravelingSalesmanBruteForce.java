...
/**
 * This class implements a brute force algorithm for solving the traveling
 * salesman problem. It can not handle many cities, since it is a NP complete
 * problem...
 *
...
public class TravelingSalesmanBruteForce {
    ...
    private void checkRoute(int[] route, int offset) {
        ...
        if (offset == salesman.n) {
            ...
            if (count % 100000 == 0) {
                //System.out.println("check route " + Arrays.toString(route) + " -- LENGTE: " + cost);
            }
